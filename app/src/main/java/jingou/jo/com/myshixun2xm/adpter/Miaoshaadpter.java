...
public class Miaoshaadpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<SgouyeBean.MiaoshaBean.ListBeanX> list;
    OnClickms onClickms;
    ...
    public Miaoshaadpter(Context context, List<SgouyeBean.MiaoshaBean.ListBeanX> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        SgouyeBean.MiaoshaBean.ListBeanX listBeanX = list.get(position);
